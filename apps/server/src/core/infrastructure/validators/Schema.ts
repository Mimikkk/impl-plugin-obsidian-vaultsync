...
export const string =
  <const T extends string>(options?: StringOptions<T>): Schema<T> =>
  (value, field, path) => {
...
export const number =
  <const T extends number>(options?: NumberOptions<T>): Schema<T> =>
  (value, field, path) => {
...
export const object =
  <const T extends Record<string, Schema>>(schema: T): Schema<T> =>
  (value, field, path) => {
...
export const array =
  <const T extends Schema>(schema: T): Schema<T[]> =>
  (value, field, path) => {
