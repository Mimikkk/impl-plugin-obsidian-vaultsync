...
export class RouteParameter {
  static create({
    ...
    format,
    options,
  }: RouteParameterNs.Options): RouteParameter {
  ...
  static integer({
    ...
    example = options?.[0] ?? "1",
    description,
  }: RouteParameterNs.IntegerOptions): RouteParameter {
  ...
  static string({
    ...
    description,
  }: RouteParameterNs.StringOptions): RouteParameter {
  ...
  static number({
    name,
    options,
    example = options?.[0] ?? "1.0",
    description,
  }: RouteParameterNs.NumberOptions): RouteParameter {
  ...
  static boolean({
    name,
    options,
    example = options?.[0] ?? "true",
    description,
  }: RouteParameterNs.BooleanOptions): RouteParameter {
