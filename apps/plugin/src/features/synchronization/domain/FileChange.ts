...
export namespace FileChanges {
  ...
  export const updateRemote = (path: string): FileChange => ({
    type: ChangeType.UpdateRemote,
    path,
  });
  export const removeLocal = (path: string): FileChange => ({ type: ChangeType.RemoveLocal, path });
  export const removeRemote = (path: string): FileChange => ({
    type: ChangeType.RemoveRemote,
    path,
  });
  export const conflict = (path: string): FileChange => ({ type: ChangeType.Conflict, path });
}
